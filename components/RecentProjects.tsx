...
const RecentProjects = () => {
  return (
    <div className="flex flex-wrap items-center justify-center p-4 gap-x-28 gap-y-16 mt-10" id='projects'>
        ...
        <div className="lg:min-h-[32.5rem] h-[25rem] flex items-center justify-center sm:w-96 w-[80vw]" key={id} >
          <PinContainer title={title} href={link}>
            <div className="relative flex items-center justify-center sm:w-96 w-[80vw] overflow-hidden h-[20vh] lg:h-[30vh] mb-10">
              ...
              >
                <Image src="/bg.png" alt="bgimg" width={500} height={800}/>
              </div>
              <Image src={img} alt="cover" className="z-10 absolute bottom-0 h-full" width={500} height={800}/>
            </div>
